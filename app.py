...
TRAINING_TEXTS = [
    ...
    "mobile battery charge drain",
    "battery dies very fast",
    "laptop battery is draining",
    "device battery problem",
    "motherboard is damaged",
    "computer motherboard not working",
    ...
    "refund is delayed",
    "i want a refund",
    "order was cancelled but refund missing",
    "delivery is late",
...
TRAINING_LABELS = [
    "Battery Issue", "Battery Issue", "Battery Issue",
    "Battery Issue", "Battery Issue",
    "Hardware Issue", "Hardware Issue",
    "Hardware Issue", "Hardware Issue",
    "Screen/Display Issue", "Screen/Display Issue",
    "Screen/Display Issue", "Screen/Display Issue",
    ...
    "Refund Issue", "Refund Issue", "Refund Issue",
...
RESPONSE_MAP = {
    ...
    "Hardware Issue":
        "Please arrange a technical inspection. "
        "The hardware support team should review the device.",

    "Screen/Display Issue":
        "Please arrange a display inspection and replacement assessment.",

    "Connectivity Issue":
        "Please check the network settings and route the complaint "
        "to technical support.",

    "Damaged Product":
        "Please provide the order details so the returns team "
        "can arrange a replacement or resolution.",

    "Wrong Product":
        "Please verify the order and delivered item so the returns "
        "team can arrange the correct product.",

    "Refund Issue":
        "Please verify the payment and refund transaction "
        "with the billing team.",

    "Delivery Delay":
        "Please verify the shipment status and provide "
        "the latest delivery update.",

    "Product Quality Issue":
        "Please review the product quality concern and route "
        "it to customer care for resolution."
}
...
def predict():
    ...
    if len(complaint) < 5:
        return jsonify({
            "error": "Complaint description is too short."
        }), 400
    ...
    suggested_response = RESPONSE_MAP.get(
        category,
        "Please review the complaint and assign it "
